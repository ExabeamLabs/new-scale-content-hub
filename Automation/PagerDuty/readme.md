...
3. Click JSON editor
4. Paste contents from https://github.com/ExabeamLabs/new-scale-content-hub/blob/main/Automation/PagerDuty/service_configuration_parameters.json
...
3. Paste code contents from action file:  https://github.com/ExabeamLabs/new-scale-content-hub/blob/main/Automation/PagerDuty/pagerduty_create_an_incident.py
4. Deploy
