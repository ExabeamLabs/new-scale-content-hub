Download, or copy and paste the contents of the ps1 file and save on your system (any system it's over cloud API). 

Make sure you replace the base url with your region, adjust the dates to whatever you need. It will export a CSV within whatever folder you ran it from.
